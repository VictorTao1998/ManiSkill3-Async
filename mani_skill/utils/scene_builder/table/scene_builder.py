...
class TableSceneBuilder(SceneBuilder):
    ...
    def initialize(self, env_idx: torch.Tensor):
        ...
        elif (self.env.robot_uids == "panda_wristcam" or self.env.robot_uids == "panda_wriststereocam" or
              self.env.robot_uids == "panda_wristactivestereocam" or self.env.robot_uids == "panda_wristactivecam"):
            # fmt: off
            qpos = np.array(
