...
from mani_skill.sensors.stereodepth_camera import D435StereoDepthCamera, D435StereoDepthCameraConfig
from mani_skill.sensors.textured_light_camera import TexturedLightCameraConfig, TexturedLightCamera
...
class BaseEnv(gym.Env):
    ...
    def get_init_raw_obs(self):
        return self._init_raw_obs
    ...
    def update_obs_space(self, obs: torch.Tensor):
        ...
        if obs is None:
            raise NotImplementedError("obs is none.")
    ...
    def _setup_sensors(self, options: dict):
        ...
        print("==============self.agent ", type(self.agent._sensor_configs[0]))
        ...
        for uid, sensor_cfg in self._sensor_configs.items():
            ...
            elif isinstance(sensor_cfg, TexturedLightCameraConfig):
                sensor_cls = TexturedLightCamera
            elif isinstance(sensor_cfg, CameraConfig):
                sensor_cls = Camera

            print("=================", sensor_cls.__name__)
